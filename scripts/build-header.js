...
const DEFAULT_TOKENS = {
  ...
  PATRIMOINE_ACTIVE_MOBILE: '',
  IMMOBILIER_ACTIVE_DESKTOP: '',
  IMMOBILIER_ACTIVE_MOBILE: '',
  FINANCEMENT_ACTIVE_DESKTOP: '',
  FINANCEMENT_ACTIVE_MOBILE: '',
  ENTREPRISES_ACTIVE_DESKTOP: '',
  ENTREPRISES_ACTIVE_MOBILE: '',
  // RESSOURCES_* = entrée « Conseils » (libellé renommé en Phase 2A-1a, nom de token conservé)
  RESSOURCES_ACTIVE_DESKTOP: '',
  RESSOURCES_ACTIVE_MOBILE: '',
