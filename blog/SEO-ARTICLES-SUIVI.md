# SEO Articles — Suivi éditorial proactifsconseils.fr

> Mettre à jour ce fichier à chaque nouvel article créé ou publié.
> Utilisé pour le maillage interne, éviter les doublons de mots-clés, et suivre la production.
...
| RSU et PEA : peut-on loger ses actions d'employeur ? | `/blog/rsu-pea-2026` | RSU PEA actions employeur 2026 | 2026-06 | ✅ Publié |
| Stock-options : exercice, imposition et stratégie 2026 | `/blog/stock-options-imposition-strategie-2026` | stock-options imposition stratégie 2026 | 2026-06 | ✅ Publié |
...
## Articles en cours / brouillons agent SEO 🔄

| Titre / Topic | Slug prévu | Mot-clé principal | Source | Statut agent |
|---|---|---|---|---|
| Gestion patrimoine entreprise | `/gestion-patrimoine-entreprise` | gestion patrimoine entreprise | Agent SEO v2 | topic approuvé (slug court — article dirigeants déjà publié) |

> Pour voir tous les topics et brouillons : https://agent-seo-proactifs-v2.vercel.app/

---

## Mots-clés déjà couverts (éviter les doublons)

- LMNP 2026 avantages fiscalité
- PER vs assurance vie comparatif
- SCI familiale création gestion
- SCPI 2026 investissement
- réduire impôts 2026
